...
class StoreApi
{
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function placeOrderAsync($body = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function placeOrderAsyncWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Model\Order';
        $request = $this->placeOrderRequest($body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function placeOrderRequest($body = null)
    {
        ...
        // form params
        if ($pet_id !== null) {
            $formParams['petId'] = ObjectSerializer::toFormValue($pet_id);
        }
        // form params
        if ($quantity !== null) {
        ...
        // form params
        if ($ship_date !== null) {
            $formParams['shipDate'] = ObjectSerializer::toFormValue($ship_date);
        }
        // form params
        if ($status !== null) {
     ...
     * @param  int $pet_id pet_id (optional)
     * @param  int $quantity quantity (optional)
     * @param  \DateTime $ship_date ship_date (optional)
     * @param  string $status status (optional)
     * @param  bool $complete complete (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\Order
     */
    public function placeOrder($id = null, $pet_id = null, $quantity = null, $ship_date = null, $status = null, $complete = null)
    {
        list($response) = $this->placeOrderWithHttpInfo($id, $pet_id, $quantity, $ship_date, $status, $complete);
        return $response;
    }
     ...
     * @param  int $pet_id (optional)
     * @param  int $quantity (optional)
     * @param  \DateTime $ship_date (optional)
     ...
     * @return array of \Swagger\Client\Model\Order, HTTP status code, HTTP response headers (array of strings)
     */
    public function placeOrderWithHttpInfo($id = null, $pet_id = null, $quantity = null, $ship_date = null, $status = null, $complete = null)
    {
        $returnType = '\Swagger\Client\Model\Order';
        $request = $this->placeOrderRequest($id, $pet_id, $quantity, $ship_date, $status, $complete);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function placeOrderAsync($id = null, $pet_id = null, $quantity = null, $ship_date = null, $status = null, $complete = null)
    {
        return $this->placeOrderAsyncWithHttpInfo($id, $pet_id, $quantity, $ship_date, $status, $complete)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function placeOrderAsyncWithHttpInfo($id = null, $pet_id = null, $quantity = null, $ship_date = null, $status = null, $complete = null)
    {
        $returnType = '\Swagger\Client\Model\Order';
        $request = $this->placeOrderRequest($id, $pet_id, $quantity, $ship_date, $status, $complete);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function placeOrderRequest($id = null, $pet_id = null, $quantity = null, $ship_date = null, $status = null, $complete = null)
    {
