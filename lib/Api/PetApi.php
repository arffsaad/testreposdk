...
class PetApi
{
     ...
     *
     * @param  \Swagger\Client\Model\Pet $body Create a new pet in the store (required)
     *
     ...
     * @param  \Swagger\Client\Model\Category $category category (required)
     * @param  string[] $photo_urls photo_urls (required)
     * @param  \Swagger\Client\Model\Tag[] $tags tags (required)
     ...
     * @return \Swagger\Client\Model\Pet
     */
    public function addPet($id, $name, $category, $photo_urls, $tags, $status)
    {
     ...
     * @param  \Swagger\Client\Model\Tag[] $tags (required)
     ...
     * @return array of \Swagger\Client\Model\Pet, HTTP status code, HTTP response headers (array of strings)
     */
    public function addPetWithHttpInfo($id, $name, $category, $photo_urls, $tags, $status)
    {
        $returnType = '\Swagger\Client\Model\Pet';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addPetAsync($id, $name, $category, $photo_urls, $tags, $status)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addPetAsyncWithHttpInfo($id, $name, $category, $photo_urls, $tags, $status)
    {
        $returnType = '\Swagger\Client\Model\Pet';
        $request = $this->addPetRequest($id, $name, $category, $photo_urls, $tags, $status);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function addPetRequest($id, $name, $category, $photo_urls, $tags, $status)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling addPet'
            );
        }
        // verify the required parameter 'name' is set
        if ($name === null || (is_array($name) && count($name) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $name when calling addPet'
            );
        }
        // verify the required parameter 'category' is set
        if ($category === null || (is_array($category) && count($category) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $category when calling addPet'
            );
        }
        // verify the required parameter 'photo_urls' is set
        if ($photo_urls === null || (is_array($photo_urls) && count($photo_urls) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $photo_urls when calling addPet'
            );
        }
        // verify the required parameter 'tags' is set
        if ($tags === null || (is_array($tags) && count($tags) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $tags when calling addPet'
            );
        }
        // verify the required parameter 'status' is set
        if ($status === null || (is_array($status) && count($status) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $status when calling addPet'
            );
        }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function findPetsByStatusRequest($status = 'available')
    {
     ...
     *
     * @param  \Swagger\Client\Model\Pet $body Update an existent pet in the store (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\Pet
     ...
     * @return \Swagger\Client\Model\Pet
     */
    public function updatePet($id, $name, $category, $photo_urls, $tags, $status)
    {
     ...
     * @return array of \Swagger\Client\Model\Pet, HTTP status code, HTTP response headers (array of strings)
     */
    public function updatePetWithHttpInfo($id, $name, $category, $photo_urls, $tags, $status)
    {
        $returnType = '\Swagger\Client\Model\Pet';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updatePetAsync($id, $name, $category, $photo_urls, $tags, $status)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updatePetAsyncWithHttpInfo($id, $name, $category, $photo_urls, $tags, $status)
    {
        $returnType = '\Swagger\Client\Model\Pet';
        $request = $this->updatePetRequest($id, $name, $category, $photo_urls, $tags, $status);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updatePetRequest($id, $name, $category, $photo_urls, $tags, $status)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling updatePet'
            );
        }
        // verify the required parameter 'name' is set
        if ($name === null || (is_array($name) && count($name) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $name when calling updatePet'
            );
        }
        // verify the required parameter 'category' is set
        if ($category === null || (is_array($category) && count($category) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $category when calling updatePet'
            );
        }
        // verify the required parameter 'photo_urls' is set
        if ($photo_urls === null || (is_array($photo_urls) && count($photo_urls) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $photo_urls when calling updatePet'
            );
        }
        // verify the required parameter 'tags' is set
        if ($tags === null || (is_array($tags) && count($tags) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $tags when calling updatePet'
            );
        }
        // verify the required parameter 'status' is set
        if ($status === null || (is_array($status) && count($status) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $status when calling updatePet'
            );
        }
    ...
    protected function uploadFileRequest($pet_id, $body = null, $additional_metadata = null)
    {
        ...
        if ($additional_metadata !== null) {
            $queryParams['additionalMetadata'] = ObjectSerializer::toQueryValue($additional_metadata, null);
        }
